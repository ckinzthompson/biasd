...
__global__ void kernel_loglikelihood(int N, void * d, double ep1, double ep2, double sigma1, double sigma2, double k1, double k2, double tau, double epsilon, void * ll);

extern "C" void load_data(int device, int N, double * d, double * ll, void * d_d, void * ll_d);
